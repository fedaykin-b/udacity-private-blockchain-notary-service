...
const signature = [signature_1, signature_2, signature_3]

for (i = 0; i < 3; i++) {
    result = bitcoinMessage.verify(message, address, signature[i]);
    console.log(`Signature ${i+1} is ${(result ? "right" : "wrong")}.`)
}
